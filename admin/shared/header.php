...
if (isset($_GET['logout'])) {
  session_unset();
  session_destroy();
  header('location:/pets/admin/pages-login.php');
}
      ...
      <li class="nav-item dropdown pe-3">
        <?php if ($_SESSION['admin']) :  ?>
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            <img src="/pets/admin/admins/upload/<?php echo  $_SESSION['image']  ?>" alt="Profile" class="rounded-circle">
        ...
        <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
          ...
          <li>
            <a class="dropdown-item d-flex align-items-center" href="/pets/admin/users-profile.php">
